About snowflake-sqlalchemy-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/snowflake-sqlalchemy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/snowflake-sqlalchemy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add snowflake-sqlalchemy
# for installing globally
pixi global install snowflake-sqlalchemy
```
...
It is possible to list all of the versions of `snowflake-sqlalchemy` available on your platform:
...
```
pixi search snowflake-sqlalchemy --channel conda-forge
```
